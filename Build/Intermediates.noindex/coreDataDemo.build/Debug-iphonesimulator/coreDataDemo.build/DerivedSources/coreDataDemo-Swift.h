...
#ifndef COREDATADEMO_SWIFT_H
#define COREDATADEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="coreDataDemo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12coreDataDemo11AppDelegate")
...
@interface Employee (SWIFT_EXTENSION(coreDataDemo))
@property (nonatomic, copy) NSString * _Nullable name;
@property (nonatomic, strong) NSNumber * _Nullable salary;
...
SWIFT_CLASS("_TtC12coreDataDemo13SceneDelegate")
...
SWIFT_CLASS("_TtC12coreDataDemo14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(coreDataDemo)) <UITableViewDataSource>
